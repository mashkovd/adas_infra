resource "aws_instance" "tfer--i-048a9cfb4c87a89d4_UGDAS-Prod-env" {
  ...
  vpc_security_group_ids = ["${data.terraform_remote_state.sg.outputs.aws_security_group_tfer--awseb-e-nupqmgez3v-stack-AWSEBSecurityGroup-dQqP27O2lwM3_sg-0607b5e6323e002bb_id}"]
}
